...
This repository contains a Python file for the **Smart Traffic Management System** and is based on **polymorphism**.
...
- `traffic_system.py` — full file with all classes and a `main()` function demonstrating the activation loop.
